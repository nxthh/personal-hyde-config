...
hl.device({
    ...
    sensitivity = 0.75, -- range: -1.0 (slowest) to 1.0 (fastest), 0 = default
})
...
hl.on("hyprland.start", function()
    hl.dispatch(hl.dsp.exec_cmd("ibus-daemon -drx"))
end)

-- Sources your external monitor definitions layout
require("monitors") 
